...
class KptCreator:
  ...
  def create_subst_private(path):
    registries = ["uhub.service.ucloud.cn/a4x-kubeflow/jetstack", "uhub.service.ucloud.cn/a4x-kubeflow/kubeflow-images-public",
                  "metacontroller"]
    for registry in registries:
      n = registry.replace("/", ".")
      name = f"image-mirror-{n}"
      value = f"uhub.service.ucloud.cn/a4x-kubeflow/project-id/mirror/{registry}"
      pattern = f"uhub.service.ucloud.cn/a4x-kubeflow/${{gcloud.core.project}}/mirror/{registry}"
